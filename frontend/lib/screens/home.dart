              ...
              Button1(
                ...
                child: Row(
                    ...
                    children: !sizing.isMobile ? [
                      CircleButton2(
                        onPressed: (btncontext) => _functionHelper[i](btncontext),
                        isVisible: false,
                        child: Icon(FontAwesomeIcons.circleQuestion, color: Colors.grey, size: 20),
                      ),
                      SizedBox(
                        width: 200,
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(_titleButon[i], style: TextStyle(color: Colors.black, fontSize: 15),),
                          ]
                        ),
                      ),
                      CircleButton2(
        ...
        child: Column(
          ...
          children: [
            for(int i=0; i<txts.length; i++)
              Text(txts[i], style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),)
          ],
        ),
      )
    ],
